...
<body class="mod-bg-1 mod-nav-link @yield('body_class', '')">
    ...
    <div class="page-wrapper">
        <div class="page-inner">
            <!-- BEGIN Left Aside -->
            @include('admin.inc._page_sidebar')
            <!-- END Left Aside -->
            <div class="page-content-wrapper">
                <!-- BEGIN Page Header -->
                @include('admin.inc._page_header')
                <!-- END Page Header -->
                <!-- BEGIN Page Content -->
    ...
    @include('admin.inc._quick_menu')
    <!-- END Quick Menu -->
    <!-- BEGIN Messenger -->
    @include('admin.inc._modal_messenger')
    <!-- END Messenger -->
    <!-- BEGIN Page Settings -->
    @include('admin.inc._modal_settings')
    <!-- END Page Settings -->
