    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('admin.inc._page_heading', [
                'icon' => 'info-circle',
                'heading1' => 'About',
                'pagedescription' => 'Developer with Repalogic',
            ])
            @endcomponent
        </div>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col">
                                        <div class="bg-faded flex-1 p-4 h-100">
                                            ...
                                            <p class="m-0">sed do eiusmod tempor incididunt ut labore et dolore
                                                magna
                                                aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sed
                                                do
